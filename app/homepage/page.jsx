...
const Homepage = () => {
    ...
    const [newTrade, setNewTrade] = useState({name: "", itemSeeking: "", description: ""});
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 min-h-screen text-white">
            <header className="bg-gray-800 shadow-lg py-6">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-gray-400 mt-2">Trade items and services in your community</p>
                </div>
            </header>
                        ...
                        >
                            <div className="p-6">
                                <div className="flex items-center mb-4">
                                    ...
                                    <span
                                        className="font-medium">{barter.itemOwner.firstName} {barter.itemOwner.lastName}</span>
                                </div>
                                <h3 className="text-xl font-semibold mb-2">{barter?.itemOffered?.name}</h3>
                        ...
                        <DialogDescription className="text-gray-400 mb-6">
                            <div className="flex items-center">
                                ...
                                <span>
                                    ...
                                    {selectedBarter.itemOwner.firstName} {selectedBarter.itemOwner.lastName}
                                    </Link>
                                </span>
                            </div>
                            <div className="mt-2">
                                <span className="font-semibold">Seeking:</span> {selectedBarter.itemSeeking}
                            </div>
                            <div className="mt-4">
                                <span
                                    className="font-semibold">Description:</span> {selectedBarter.itemOffered.description}
                            </div>
                            <div className="mt-4">
            ...
            <Dialog open={isCreateDialogOpen} onOpenChange={handleCreateClose}>
                <DialogContent className="bg-gray-800 text-white rounded-lg shadow-xl max-w-md w-full mx-auto">
                    <DialogTitle className="text-2xl font-bold mb-6 text-center">Create New Trade</DialogTitle>
                    <form onSubmit={handleFormSubmit} className="space-y-6">
                        ...
                        <div>
                            <label htmlFor="itemSeeking" className="block text-sm font-medium mb-2">
                                Item Seeking
                            </label>
                            <input
                                id="itemSeeking"
