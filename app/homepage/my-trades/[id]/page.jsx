...
const MyTrades = () => {
    ...
    const fetchOutgoingBarters = useCallback(async () => {
        try {
            const response = await fetch("/api/outgoing-barters");
            const data = await response.json();
            const sortedBarters = data.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));
            setOutgoingBarters(sortedBarters);
        } catch (error) {
            console.error(error);
        }
    }, []);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setOutgoingBarters(prevBarters => [barter, ...prevBarters]);
