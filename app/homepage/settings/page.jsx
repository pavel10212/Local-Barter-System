            ...
            <main className="container mx-auto px-4 py-8 space-y-8">
                        ...
                        <form className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="first-name" name="first-name" className="bg-gray-700 text-white border-gray-600" />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="last-name" className="text-gray-300">Last Name</Label>
                                    <Input id="last-name" name="last-name" className="bg-gray-700 text-white border-gray-600" />
                                </div>
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="email" className="text-gray-300">Email address</Label>
                                <Input id="email" name="email" type="email" className="bg-gray-700 text-white border-gray-600" />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="address" className="text-gray-300">Address</Label>
                                <Input id="address" name="address" className="bg-gray-700 text-white border-gray-600" />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="phone-number" className="text-gray-300">Phone Number</Label>
                                <Input id="phone-number" name="phone-number" type="tel" className="bg-gray-700 text-white border-gray-600" />
                            </div>
                ...
                <Card className="bg-gray-800 text-white">
                    <CardHeader>
                        ...
                        <CardDescription className="text-gray-400">Find answers to common questions or contact our support team</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Accordion type="single" collapsible className="w-full">
                            <AccordionItem value="faq" className="border-b border-gray-700">
                                <AccordionTrigger className="text-white hover:text-gray-300">Frequently Asked Questions</AccordionTrigger>
                            ...
                            <AccordionItem value="contact" className="border-b border-gray-700">
                                <AccordionTrigger className="text-white hover:text-gray-300">Contact Support</AccordionTrigger>
                                <AccordionContent className="text-gray-300">
                                    <p>
